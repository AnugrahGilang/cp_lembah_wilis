                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="portfolio-filter">
                            ...
                            <button type="button" data-filter="photography">Kolam Renang</button>
                            <button type="button" data-filter="ios">Spot Foto</button>
                            <button type="button" data-filter="development">Tubing Sungai</button>
                            <button type="button" data-filter="design">Restoran</button>
                        </div>
