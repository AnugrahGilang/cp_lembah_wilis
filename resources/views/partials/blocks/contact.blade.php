            ...
            <div class="row">
                ...
                <div class="contact-details col-md-6 ">
                    ...
                    <div class="social-icon">
                        <ul>
                            <li><a href="{{ asset('https://themefisher.com/') }}"><i class="tf-ion-social-facebook"></i></a></li>
                            <li><a href="{{ asset('https://themefisher.com/') }}"><i class="tf-ion-social-twitter"></i></a></li>
                            <li><a href="{{ asset('https://themefisher.com/') }}"><i class="tf-ion-social-dribbble-outline"></i></a></li>
                            <li><a href="{{ asset('https://themefisher.com/') }}"><i class="tf-ion-social-linkedin-outline"></i></a></li>
                        </ul>
                    </div>
