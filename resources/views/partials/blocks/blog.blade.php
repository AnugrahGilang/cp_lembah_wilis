		...
		<div class="row">
			...
			<article class="col-lg-4 col-md-6">
				<div class="post-item">
					...
					<div class="content">
						<h3><a href="{{ asset('single_post.blade.php') }}">Reasons to Smile</a></h3>
						...
						<a class="btn btn-main" href="{{ asset('single_post.blade.php') }}">Read more</a>
					</div>
				</div>
			</article>
			<!-- /single blog post -->
			...
			<article class="col-lg-4 col-md-6">
				<div class="post-item">
					...
					<div class="content">
						<h3><a href="{{ asset('single_post.blade.php') }}">A Few Moments</a></h3>
						<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non skateboard dolor brunch.</p>
						<a class="btn btn-main" href="{{ asset('single_post.blade.php') }}">Read more</a>
					</div>
				</div>
			...
			<article class="col-lg-4 col-md-6">
				<div class="post-item">
					...
					<div class="content">
						<h3><a href="{{ asset('single_post.blade.php') }}">Hints for Life</a></h3>
						<p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non skateboard dolor brunch.</p>
						<a class="btn btn-main" href="{{ asset('single_post.blade.php') }}">Read more</a>
					</div>
				</div>
